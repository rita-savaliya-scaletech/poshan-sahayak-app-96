...
const resources = {
  en: {
    translation: {
      ...
      aiPhotoPrompt: "Please Share a photo of today's meal so I can do a proper nutritional analysis. 📸",
  ...
  gu: {
    translation: {
      ...
      aiPhotoPrompt: 'કૃપા કરીને આજના ભોજનનો ફોટો શેર કરો જેથી હું યોગ્ય પોષણ વિશ્લેષણ કરી શકું. 📸',
